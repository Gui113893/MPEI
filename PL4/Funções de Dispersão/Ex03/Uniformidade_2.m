function Uniformidade_2(hashcodes, fun, size, i)
hashcodes_normalized = hashcodes{i} / size;

theoretical_moment_2 = 1/3;
theoretical_moment_5 = 1/6;
theoretical_moment_10 = 1/11;
